...
public class CoverFlow extends Gallery {
    ...
    private void parseAttributes(final Context context, final AttributeSet attrs) {
        ...
        try {
            imageWidth = a.getDimension(R.styleable.CoverFlow_imageWidth, 480); //in file attrs.xml
            imageHeight = a.getDimension(R.styleable.CoverFlow_imageHeight, 320); //in res/values
