...
public class MyBDD {
    ...
    private static final String NOM_BDD = "testBdd3.db";
    ...
    private static final int NUM_COL_PEOPLE_NAME = 1;
    private static final String COL_PEOPLE_FIRST_NAME = "FIRST_NAME";
    private static final int NUM_COL_PEOPLE_FIRST_NAME = 2;
    private static final String COL_PEOPLE_SEXE = "SEXE";
    private static final int NUM_COL_PEOPLE_SEXE = 3;
    private static final String COL_PEOPLE_DATE_OF_BIRTH = "DATE_OF_BIRTH";
    private static final int NUM_COL_PEOPLE_DATE_OF_BIRTH = 4;
    ...
    private static final int NUM_COL_LINK_IDREDU = 3;
...
/** FONCTIONS RECUPERATION ************************************************************************/
    ...
    public People getPeopleWithId(int id) {
        Cursor c = bdd.query(TABLE_PEOPLE, new String[]{COL_PEOPLE_ID, COL_PEOPLE_NAME, COL_PEOPLE_FIRST_NAME, COL_PEOPLE_SEXE, COL_PEOPLE_DATE_OF_BIRTH}, COL_PEOPLE_ID + " LIKE \"" + id + "\"", null, null, null, null);
    ...
    public Link getLinkWithIdComp(int idComp){
        Cursor c = bdd.query(TABLE_LINK, new String[] {COL_LINK_ID, COL_LINK_IDCOMP, COL_LINK_IDPEOP, COL_LINK_IDREDU}, COL_LINK_IDCOMP + " LIKE \"" + idComp +"\"", null, null, null, null);
        return cursorToLink(c);
    }

    public Link getLinkWithIdPeop(int idPeop){
        Cursor c = bdd.query(TABLE_LINK, new String[] {COL_LINK_ID, COL_LINK_IDCOMP, COL_LINK_IDPEOP, COL_LINK_IDREDU}, COL_LINK_IDPEOP + " LIKE \"" + idPeop +"\"", null, null, null, null);
        return cursorToLink(c);
    }

    public Link getLinkWithIdRedu(int idRedu){
        Cursor c = bdd.query(TABLE_LINK, new String[] {COL_LINK_ID, COL_LINK_IDCOMP, COL_LINK_IDPEOP, COL_LINK_IDREDU}, COL_LINK_IDREDU + " LIKE \"" + idRedu +"\"", null, null, null, null);
        return cursorToLink(c);
    }


/** ALREADY EXISTS ********************************************************************************/
    int getIdIfCompanyAlreadyExists(Company company){
    ...
    int getIdIfPeopleAlreadyExists(People people){
        Cursor c = bdd.query(TABLE_PEOPLE, new String[] {COL_PEOPLE_ID, COL_PEOPLE_NAME, COL_PEOPLE_FIRST_NAME, COL_PEOPLE_SEXE, COL_PEOPLE_DATE_OF_BIRTH}, COL_PEOPLE_NAME + " = '" + people.getName() + "'"
                + " AND " + COL_PEOPLE_FIRST_NAME + " = \"" + people.getFirstName() + "\""
                + " AND " + COL_PEOPLE_SEXE + " = \"" + people.getSexe() + "\""
                + " AND " + COL_PEOPLE_DATE_OF_BIRTH + " = \"" + people.getDateOfBirth() + "\"", null, null, null, null);
    ...
    int getIdIfReductionAlreadyExists(Reduction reduction){
    ...
    int getIdIfLinkAlreadyExists(Link link){
        Cursor c = bdd.query(TABLE_LINK, new String[] {COL_LINK_ID, COL_LINK_IDCOMP, COL_LINK_IDPEOP, COL_LINK_IDREDU}, COL_LINK_IDCOMP + " = \"" + link.getIdComp() +"\""
...
/** FONCTIONS AFFICHAGE ***************************************************************************/
    ...
    public String showPeople() {
        ...
        String s = new String(COL_PEOPLE_ID + " | " + COL_PEOPLE_NAME + " | " + COL_PEOPLE_FIRST_NAME + " | " + COL_PEOPLE_SEXE + " | " + COL_PEOPLE_DATE_OF_BIRTH + "\n");
        People people = new People();
        ...
        do
        {
            ...
            s += people.getId() + " | " + people.getName() + " | " + people.getFirstName() + " | " + people.getSexe() + " | " + people.getDateOfBirth() + "\n";
        } while(c.moveToNext());
    ...
    public String showLink() {
        ...
        String s = new String(COL_LINK_ID + " | " + COL_LINK_IDCOMP + " | " + COL_LINK_IDPEOP + " | " + COL_LINK_IDREDU + "\n");
        Link link = new Link();
        ...
        do
        {
            ...
            s += link.getId() + " | " + link.getIdComp() + " | " + link.getIdPeop() + " | " + link.getIdRedu() + "\n";
        } while(c.moveToNext());
