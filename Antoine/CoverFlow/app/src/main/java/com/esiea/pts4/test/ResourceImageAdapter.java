...
import com.esiea.pts4.test.coverflowtest.R;
...
public class ResourceImageAdapter extends AbstractCoverFlowImageAdapter {
    ...
    private static final int[] DEFAULT_RESOURCE_LIST = { R.drawable.ic_maxpedition_logo, R.drawable.ic_decathlon_logo, R.drawable.ic_fnac_logo,
            R.drawable.ic_darty_logo };
